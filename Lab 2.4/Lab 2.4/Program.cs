...
namespace Lab_2._4
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // 7. Create two strings with the name color1 and color2. Assign color1 the value
            ...
            // 13. On a new line, assign numbers the value of mySecondNumber divided by
            // myFirstNumber, but this time, cast myFirstNumber as a double.
            numbers = mySecondNumber / (double)myFirstNumber;
            // 14. Print the value of numbers to the console.
            Console.WriteLine(numbers);

            // 15.Use Console.WriteLine to print the text “Breakpoint Here”. Insert a breakpoint to
            // pause execution at this line. Run the program, and inspect the values of all of your
            // variables. Hover your mouse over the variable to see it’s value appear. 
            ...
            // 18. Create a DateTime variable called rightNow and set it’s value to Datetime.Now.
            // Print the results
